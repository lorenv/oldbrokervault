          ...
          <div className="max-w-7xl mx-auto space-y-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 lg:order-1">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Create custom NDA templates with drag-and-drop signature fields. Upload PDFs and position signature, 
                  name, date, and email fields exactly where you need them for professional document signing.
                </p>
                <div className="flex flex-wrap gap-3">
                  ...
                  <span className="px-4 py-2 bg-purple-100 text-purple-800 rounded-full text-sm font-medium">Digital Signatures</span>
                </div>
              </div>
              <div 
                ...
                onClick={() => setEnlargedImage("/nda-template-editor-preview.png")}
              >
                <img 
                  src="/nda-template-editor-preview.png" 
                  alt="NDA Template Editor with Drag & Drop Fields"
                  className="w-full h-auto object-cover"
                />
              </div>
            </div>
            ...
            {/* E-Signature Feature - Text Left, Image Right */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 lg:order-1">
                <h3 className="text-3xl font-bold text-gray-900">Drag & Drop E-Signature</h3>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Create professional signature templates with intuitive drag & drop field placement. 
                  Build custom NDA templates with signature, name, date, email, and text fields positioned exactly where you need them.
                </p>
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Drag & Drop Fields</span>
                  <span className="px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-medium">Custom Templates</span>
                  <span className="px-4 py-2 bg-purple-100 text-purple-800 rounded-full text-sm font-medium">PDF Integration</span>
                </div>
              </div>
              <div 
                className="bg-white rounded-lg shadow-xl overflow-hidden cursor-pointer hover:shadow-2xl transition-shadow duration-300 lg:order-2"
