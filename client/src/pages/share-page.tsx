      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="space-y-6">
          {shareData.cim.isUploadedFile ? (
            ...
            <div className="space-y-8">
              {/* Contact Information for flexible CIM documents */}
              {shareData.cim.userProfile && (
                <Card className="w-full max-w-5xl mx-auto border-0 shadow-2xl bg-gradient-to-br from-white/95 to-gray-50/95 backdrop-blur-md rounded-2xl overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-slate-50 to-blue-50/50 pb-6 pt-8 px-8">
                    <CardTitle className="flex items-center gap-3 text-2xl font-bold text-slate-800">
                            ...
                            <div className="space-y-3">
                              ...
                              {shareData.cim.userProfile.phone && (
                                <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                  ...
                                  <a href={`tel:${shareData.cim.userProfile.phone}`} className="text-green-600 font-medium hover:text-green-700 transition-colors">
                                    {shareData.cim.userProfile.phone}
                                  </a>
                                </div>
                              )}
