      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose max-w-none space-y-6">
          ...
          <section>
            ...
            <p>
              This End User License Agreement ("EULA") is a legal agreement between you ("User" or "You") and Dealve Inc., a Delaware corporation ("Company," "We," or "Us") for the use of the CIM Share software platform ("Software" or "Service"). By registering for an account, accessing, or using our Service, you agree to be bound by the terms of this EULA.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">8. Financial Information and Analysis Tools Disclaimer</h2>
            <p>
              <strong>No Liability for Financial Representations:</strong> The Software includes tools for analyzing and processing financial information, including but not limited to the SDE Analyzer and other financial analysis features. You expressly acknowledge and agree that:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>The Company is not liable or responsible for any misrepresentations, inaccuracies, or errors in financial statements, business materials, or any other information processed through the Software</li>
              <li>All responsibility for the accuracy, completeness, and validity of financial information and business materials rests solely with you, the User</li>
              <li>You are required to independently verify all financial data, calculations, analyses, and outputs generated by the Software's tools, including the SDE Analyzer</li>
              <li>The Software's analytical tools provide automated assistance only and do not constitute professional financial, accounting, or legal advice</li>
              <li>You must engage qualified professionals (accountants, financial advisors, attorneys) to review all financial materials before relying on them for business decisions or sharing them with third parties</li>
              <li>We make no representations or warranties regarding the accuracy, reliability, or suitability of any financial analysis or output generated by the Software</li>
              <li>You assume all risks associated with the use of financial analysis tools and agree to hold the Company harmless from any claims, losses, or damages arising from reliance on such outputs</li>
            </ul>
            <p className="mt-3">
              <strong>User Verification Obligation:</strong> It is your sole responsibility to verify all facts, figures, calculations, and financial representations generated by or processed through the Software before using such information for any purpose, including but not limited to business valuations, sale transactions, investor presentations, or financial disclosures.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">15. Changes to This EULA</h2>
            <p>
