...
export function DocumentEditTab({ cimDocument, financialFiles, customSections }: DocumentEditTabProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="border-0 shadow-xl bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden ring-1 ring-gray-200/50 mb-6">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 pb-6 pt-8 px-8 shadow-lg">
